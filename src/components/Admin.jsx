...
const Admin = () => {
  ...
  // State untuk melacak kartu terakhir yang diklik
  const [lastClicked, setLastClicked] = useState(null); // 'users' atau 'agencies'
  ...
  // Memperbarui fungsi untuk mengatur lastClicked
  const handleShowUsers = () => {
    setShowUsersTable(!showUsersTable);
    setLastClicked('users'); // Menandai bahwa users card diklik terakhir
  };

  const handleShowAgencies = () => {
    setShowAgenciesTable(!showAgenciesTable);
    setLastClicked('agencies'); // Menandai bahwa agencies card diklik terakhir
  };
  ...
  return (
    <div className="container mt-4">
      ...
      <div className="row mb-4 justify-content-center">
        {/* Card Jumlah Bidang (Non-Interaktif) */}
        <div className="col-md-3">
          ...
          >
            <div className="card-body">
              ...
              <p className="text-muted">Informasi</p> {/* Tulisan 'Info' */}
            </div>
          </div>
        </div>

        {/* Card Jumlah Instansi */}
        <div className="col-md-3">
          <div
            className="card text-center shadow-sm mb-3"
            style={{
          ...
          >
            <div className="card-body">
              ...
              <p className="text-muted">Klik di sini</p> {/* Tulisan 'Klik di sini' */}
            </div>
          </div>
        </div>
      ...
      {/* Render Tabel Berdasarkan lastClicked */}
      {(showUsersTable || showAgenciesTable) && (
        <div>
          {/* Jika kedua tabel ditampilkan */}
          {showUsersTable && showAgenciesTable ? (
            <>
              {/* Tabel yang diklik terakhir akan dirender terlebih dahulu */}
              {lastClicked === 'users' && (
                <>
                  {/* Tabel Pengguna */}
            ...
            // Jika hanya salah satu tabel yang ditampilkan
            <>
              {showUsersTable && (
                <div className="card mb-4">
                  <div className="card-header">
